...
enum class SettingsID
{
    ...
    GUI_OnScreenDisplayFPSCounter,
    GUI_OnScreenDisplayNetplayBufferAlerts,
    GUI_OnScreenDisplayNetplayDesyncAlerts,
    GUI_OnScreenDisplayNetplayChatMessages,
    GUI_OnScreenDisplayScale,
    GUI_OnScreenDisplayCustomLayout,
    GUI_OnScreenDisplayMessagePos,
    GUI_OnScreenDisplayOverlayPos,
    GUI_OnScreenDisplayTurnCountPos,
    GUI_NetplayShareSystemMessagesInChat,
    GUI_Toolbar,
    GUI_ToolbarArea,
    GUI_StatusBar,
    GUI_Theme,
