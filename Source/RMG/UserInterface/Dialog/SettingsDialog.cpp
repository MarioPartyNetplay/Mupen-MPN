...
void SettingsDialog::loadInterfaceEmulationSettings(void)
{
    ...
    this->dedicatedRenderWindowCheckBox->setChecked(CoreSettingsGetBoolValue(SettingsID::GUI_DedicatedRenderWindow));
...
void SettingsDialog::loadDefaultInterfaceEmulationSettings(void)
{
    ...
    this->dedicatedRenderWindowCheckBox->setChecked(CoreSettingsGetDefaultBoolValue(SettingsID::GUI_DedicatedRenderWindow));
...
void SettingsDialog::saveInterfaceEmulationSettings(void)
{
    ...
    CoreSettingsSetValue(SettingsID::GUI_DedicatedRenderWindow, this->dedicatedRenderWindowCheckBox->isChecked());
