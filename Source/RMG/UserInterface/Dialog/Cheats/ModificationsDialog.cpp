...
ModificationsDialog::ModificationsDialog(QWidget *parent) : QDialog(parent)
{
...
bool ModificationsDialog::HasFailed(void)
{
    return this->failedToParseCheats;
}

void ModificationsDialog::loadCheats(void)
{
...
QTreeWidgetItem* ModificationsDialog::findItem(QStringList sections, int size, QString itemText)
{
...
QString ModificationsDialog::getTreeWidgetItemTextFromCheat(CoreCheat cheat)
{
...
void ModificationsDialog::showErrorMessage(QString error, QString details)
{
...
void ModificationsDialog::on_cheatsTreeWidget_itemChanged(QTreeWidgetItem *item, int column)
{
...
void ModificationsDialog::on_cheatsTreeWidget_currentItemChanged(QTreeWidgetItem *current, QTreeWidgetItem *previous)
{
...
void ModificationsDialog::on_cheatsTreeWidget_itemDoubleClicked(QTreeWidgetItem *item, int column)
{
    if (item == nullptr || item->data(column, Qt::UserRole).isNull())
    {
        return;
...
void ModificationsDialog::on_addCheatButton_clicked(void)
{
...
void ModificationsDialog::on_editCheatButton_clicked(void)
{
...
void ModificationsDialog::on_removeCheatButton_clicked(void)
{
    QTreeWidgetItem* item = this->cheatsTreeWidget->currentItem();
