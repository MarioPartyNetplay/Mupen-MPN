...
install_name_tool -change '@rpath/libRMG-Core.dylib' @loader_path/libRMG-Core.dylib 
"${contents}/MacOS/RMG-MPN"
install_name_tool -change '@rpath/libmupen64plus.dylib' @loader_path/libmupen64plus.dylib 
"${contents}/MacOS/RMG-MPN"
